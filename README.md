...
| `VITE_ENABLE_AI_PASSWORD` | Enable AI password protection (default: `false`). | No |
| `VITE_ENABLE_HASH_PASSWORD` | Enable SHA-256 hash check for password (default: `false`). Set to `true` if your password file contains a hash. | No |
